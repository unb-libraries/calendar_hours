...
class CalendarResource extends ResourceBase {
   ...
   *
   * @param \Drupal\Core\Config\Entity\ConfigEntityStorageInterface $hours_calendar_storage
   *   The Storage manager for HoursCalendar entities.
   ...
   *   A logger instance.
   */
  public function __construct(ConfigEntityStorageInterface $hours_calendar_storage, array $configuration, $plugin_id, $plugin_definition, array $serializer_formats, LoggerInterface $logger) {
